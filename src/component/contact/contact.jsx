...
Page Banner START --> */}
			<section className="pt-5 pb-0"
			 style={{ backgroundImage: "url(assets/images/element/map.svg)", backgroundPosition: "center left", backgroundSize: " cover" }}
			>
						...
						<div className="col-md-6 align-items-center text-center">
							...
							<div className="d-sm-flex align-items-center justify-content-center mt-2 mt-sm-4">
								...
								<ul className="list-inline mb-0 ms-sm-2">
									<li className="list-inline-item"> <a className="fs-5 me-1 text-facebook" href="#"><i
										className="fab fa-fw fa-facebook-square"></i></a> </li>
									<li className="list-inline-item"> <a className="fs-5 me-1 text-instagram" href="#"><i
										className="fab fa-fw fa-instagram"></i></a> </li>
									<li className="list-inline-item"> <a className="fs-5 me-1 text-twitter" href="#"><i
										className="fab fa-fw fa-twitter"></i></a> </li>
									<li className="list-inline-item"> <a className="fs-5 me-1 text-linkedin" href="#"><i
										className="fab fa-fw fa-linkedin-in"></i></a> </li>
									<li className="list-inline-item"> <a className="fs-5 me-1 text-dribbble" href="#"><i
										className="fas fa-fw fa-basketball-ball"></i></a> </li>
									<li className="list-inline-item"> <a className="fs-5 me-1 text-pinterest" href="#"><i
										className="fab fa-fw fa-pinterest"></i></a> </li>
								</ul>
							</div>
						</div>
						...
						<div className="col-md-6">
							...
							<form>
								...
								<div className="mb-4 bg-light-input">
									<label htmlFor="yourName" className="form-label text-black">Your name *</label>
									<input type="text" className="form-control form-control-lg" id="yourName" />
								</div>
								{/* <!-- Email --> */}
								<div className="mb-4 bg-light-input">
									<label htmlFor="emailInput" className="form-label text-black">Email address *</label>
									<input type="email" className="form-control form-control-lg" id="emailInput" />
								</div>
								{/* <!-- Message --> */}
								<div className="mb-4 bg-light-input">
									<label htmlFor="textareaBox" className="form-label text-black">Message *</label>
				...
				<div className="container">
					<div className="row">
						<div className="col-12">
							<iframe className="w-100 h-400px grayscale rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095343008!2d-74.00425878428698!3d40.74076684379132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf5c1654f3%3A0xc80f9cfce5383d5d!2sGoogle!5e0!3m2!1sen!2sin!4v1586000412513!5m2!1sen!2sin" height="500" style={{border:"0px"}} aria-hidden="false" tabIndex="0"></iframe>
						</div>
					</div>
				</div>
			</section>
