                ...
                <div class="container position-relative">
                    <div class="row g-5 align-items-center justify-content-center">
                        <div class="col-lg-5">
                            ...
                            {/* <!-- info --> */}
                            <p>
                                Hey you! Eduport is coming. We are doing our best to launch our
                                website and we will be back soon.
                            </p>
                            {/* <!-- Progress bar --> */}
                            <div class="overflow-hidden mt-4">
                                ...
                                <div class="progress progress-md progress-percent-bg bg-light">
                                    <div
                                        class="progress-bar progress-bar-striped bg-blue aos"
                            ...
                            <form class="mt-4">
                                ...
                                <div class="bg-body border rounded-2 p-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        />
                                        <button type="button" class="btn btn-blue mb-0 rounded-2">
                                            Notify Me!
                                        </button>
                                    </div>
                                </div>
