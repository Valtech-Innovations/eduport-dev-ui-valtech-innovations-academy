        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="tiny-slider arrow-round arrow-creative arrow-dark arrow-hover">
              <div
                className="tiny-slider-inner d-flex flex-row justify-content-between"
                data-autoplay="true"
                data-edge="5"
                data-arrow="true"
                data-dots="false"
              ...
              >
                {/* <!-- Feedback item --> */}
                <div>
                  <div className="bg-body text-center py-5 px-4 m-3 rounded-3 border border-1 position-relative">
                    {/* <!-- Avatar --> */}
